    ...
    const fetchData = async () => {
      try {
        if (userData && userData.role === 'superadmin') {
          ...
          const purposesResponse = await axios.get('http://localhost:5000/api/get-all-purposes');
          const usersResponse = await axios.get('http://localhost:5000/api/get-all-users');
          ...
          const regularEntriesResponse = await axios.get('http://localhost:5000/api/get-all-regular-entries');
          const houseListResponse = await axios.get('http://localhost:5000/api/get-all-house-list');
          const entriesResponse = await axios.get('http://localhost:5000/api/get-all-type-of-entries');
          const purposesResponse = await axios.get('http://localhost:5000/api/get-all-purposes');
